...
class EmailService:
    ...
    @staticmethod
    def send_email_verification(user: User, token: str, code: str, 
                              request=None) -> bool:
        """
    ...
    @staticmethod
    def send_password_reset(user: User, token: str, code: str, 
                          request=None) -> bool:
        """
        ...
        try:
            # Build reset URL
            reset_url = EmailService._build_password_reset_url(
                token, code, request
            )
