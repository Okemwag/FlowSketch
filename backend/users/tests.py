...
class AuthenticationAPITests(APITestCase):
    ...
    def test_user_login_success(self):
        ...
        self.assertTrue(
            UserSession.objects.filter(user=user).exists()
        )
...
class PasswordManagementTests(APITestCase):
    ...
    def test_change_password_success(self):
        ...
        with patch('users.services.email_service.EmailService.send_password_changed_notification') as mock_email:
...
class EmailVerificationTests(APITestCase):
    ...
    def test_confirm_email_verification(self):
        ...
        with patch('users.services.email_service.EmailService.send_welcome_email') as mock_email:
            mock_email.return_value = True
