...
def request_password_reset(request):
    ...
    if serializer.is_valid():
        ...
        EmailService.send_password_reset(
            user=user, token=reset_token.token, code=reset_token.code, request=request
        )
...
@extend_schema_view(
    ...
    destroy=extend_schema(
        summary="Delete team", description="Delete a team (owner only).", tags=["Teams"]
    ),
)
