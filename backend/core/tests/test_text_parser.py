...
class TestTextParserService:
    ...
    def test_advanced_process_detection(self, parser_service):
        ...
        relationships = [
            Relationship("validation process", "payment process", "flows_to", "Flows To", 0.8),
            Relationship("payment process", "fulfillment process", "flows_to", "Flows To", 0.8)
        ]
    ...
    def test_diagram_type_suggestions(self, parser_service):
        ...
        suggestions = service.get_diagram_type_suggestions(text, entities, relationships)
    ...
    def test_mixed_content_diagram_selection(self, parser_service):
        ...
        assert diagram_type in [DiagramType.ERD, DiagramType.PROCESS, DiagramType.FLOWCHART]
    ...
    def test_confidence_threshold_fallback(self, parser_service):
        ...
        entities = [
            Entity("content", EntityType.OBJECT, {}, 0.8, 5, 12)
        ]
        relationships = []
    ...
    def test_enhanced_sequence_detection(self, parser_service):
        ...
        # Test scoring method
        sequence_score = service._calculate_sequence_score(text, entities, relationships)
    ...
    def test_enhanced_class_detection(self, parser_service):
        ...
        relationships = [
            ...
            Relationship("Dog class", "Mammal interface", "implements", "Implements", 0.8)
        ]
    ...
    def test_enhanced_process_detection(self, parser_service):
        ...
        relationships = [
            Relationship("validation step", "payment process", "precedes", "Precedes", 0.7),
    ...
    def test_mixed_content_scoring(self, parser_service):
        ...
        relationships = [
            ...
            Relationship("Order object", "Database table", "stored_in", "Stored In", 0.7)
        ]
    ...
    def test_contextual_relationship_detection(self, parser_service):
        ...
        temporal_rel = next((r for r in relationships if r.type in ["follows", "precedes"]), None)
    ...
    def test_complex_sentence_parsing(self, parser_service):
        ...
        text = ("When User creates Order, Payment System validates payment, "
